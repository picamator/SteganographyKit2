<?php
namespace Picamator\SteganographyKit2\Tests\Helper\Kernel\Pixel;

use PHPUnit\Framework\TestCase;

/**
 * Help to mock Pixel\Api\PixelInterface
 */
class PixelHelper
{
    /**
     ...
     * Gets pixel mock
     *
     * @return \Picamator\SteganographyKit2\Kernel\Pixel\Api\PixelInterface | \PHPUnit_Framework_MockObject_MockObject
     */
     ...
     * Gets byte mock
     *
     * @return \Picamator\SteganographyKit2\Kernel\Primitive\Api\Data\ByteInterface | \PHPUnit_Framework_MockObject_MockObject
     */
    private function getByteMock(): \PHPUnit_Framework_MockObject_MockObject
    {
        return $this->getMockBuilder('Picamator\SteganographyKit2\Kernel\Primitive\Api\Data\ByteInterface')
            ->getMock();
    }
