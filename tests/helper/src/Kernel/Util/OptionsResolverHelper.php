<?php
namespace Picamator\SteganographyKit2\Tests\Helper\Kernel\Util;
...
class OptionsResolverHelper
{
     ...
     * @param array $options
     *
     * @return \Picamator\SteganographyKit2\Kernel\Util\Api\OptionsResolverInterface | \PHPUnit_Framework_MockObject_MockObject
     *
    ...
    public function stubOptionsResolver(array $options) : \PHPUnit_Framework_MockObject_MockObject
    {
        ...
        $optionsResolverMock = $this->getMockBuilder('Picamator\SteganographyKit2\Kernel\Util\Api\OptionsResolverInterface')
            ->getMock();
