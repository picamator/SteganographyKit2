...
class ImageTest extends BaseTest
{
    ...
    /**
     * @var \Picamator\SteganographyKit2\Image\Api\ResourceInterface | \PHPUnit_Framework_MockObject_MockObject
     */
    private $resourceMock;

    /**
     * @var \Picamator\SteganographyKit2\Image\Api\Iterator\IteratorFactoryInterface | \PHPUnit_Framework_MockObject_MockObject
     */
    ...
    /**
     * @var \Picamator\SteganographyKit2\Image\Api\SizeFactoryInterface | \PHPUnit_Framework_MockObject_MockObject
     */
    ...
    protected function setUp()
    {
        ...
        $this->resourceMock = $this->getMockBuilder('Picamator\SteganographyKit2\Image\Api\ResourceInterface')
            ->getMock();

        $this->iteratorFactoryMock = $this->getMockBuilder('Picamator\SteganographyKit2\Image\Api\Iterator\IteratorFactoryInterface')
            ->getMock();

        $this->iteratorMock = $this->getMockBuilder('Iterator')
            ->getMock();

        $this->sizeFactoryMock = $this->getMockBuilder('Picamator\SteganographyKit2\Image\Api\SizeFactoryInterface')
            ->getMock();
