...
{
    /**
     * @var \Picamator\SteganographyKit2\Image\Export\AbstractString | \PHPUnit_Framework_MockObject_MockObject
     */
    private $stringMock;
    ...
    protected function setUp()
    {
        ...
        $this->stringMock = $this->getMockBuilder('Picamator\SteganographyKit2\Image\Export\AbstractString')
