...
use Picamator\SteganographyKit2\Text\Iterator\SerialIterator;
...
class SerialIteratorTest extends BaseTest
{
    ...
    /**
     * @var \Picamator\SteganographyKit2\Text\Api\AsciiFactoryInterface | \PHPUnit_Framework_MockObject_MockObject
     */
    ...
    protected function setUp()
    {
        ...
        $this->asciiFactoryMock = $this->getMockBuilder('Picamator\SteganographyKit2\Text\Api\AsciiFactoryInterface')
            ->getMock();
