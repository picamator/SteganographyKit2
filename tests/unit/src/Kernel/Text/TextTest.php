...
class TextTest extends BaseTest
{
    ...
    /**
     * @var \Picamator\SteganographyKit2\Kernel\Text\Api\Data\LengthInterface | \PHPUnit_Framework_MockObject_MockObject
     */
    private $lengthMock;
    ...
    protected function setUp()
    {
        ...
        $this->lengthMock = $this->getMockBuilder('Picamator\SteganographyKit2\Kernel\Text\Api\Data\LengthInterface')
            ->getMock();
    }
