...
{
    /**
     * @var \Picamator\SteganographyKit2\Kernel\StegoSystem\Api\EncodeInterface | \PHPUnit_Framework_MockObject_MockObject
     */
    private $encodeMock;

    /**
     * @var \Picamator\SteganographyKit2\Kernel\StegoSystem\Api\DecodeInterface | \PHPUnit_Framework_MockObject_MockObject
     */
    private $decodeMock;
    ...
    protected function setUp()
    {
        ...
        $this->encodeMock = $this->getMockBuilder('Picamator\SteganographyKit2\Kernel\StegoSystem\Api\EncodeInterface')
            ->getMock();

        $this->decodeMock = $this->getMockBuilder('Picamator\SteganographyKit2\Kernel\StegoSystem\Api\DecodeInterface')
            ->getMock();
    }
    ...
    {
        // secret text mock
        $secretTextMock = $this->getMockBuilder('Picamator\SteganographyKit2\Kernel\SecretText\Api\SecretTextInterface')
            ->getMock();

        // cover text mock
        $coverTextMock = $this->getMockBuilder('Picamator\SteganographyKit2\Kernel\CoverText\Api\CoverTextInterface')
            ->getMock();

        // stego text mock
        $stegoTextMock = $this->getMockBuilder('Picamator\SteganographyKit2\Kernel\StegoText\Api\StegoTextInterface')
            ->getMock();
        ...
        // stego system mock
        $stegoSystemMock = $this->getMockBuilder('Picamator\SteganographyKit2\Kernel\StegoSystem\StegoSystem')
    ...
    {
        // observer a mock
        $observerAMock = $this->getMockBuilder('Picamator\SteganographyKit2\Kernel\StegoSystem\Api\ObserverInterface')
            ->getMock();
        ...
        // observer b mock
        $observerBMock = $this->getMockBuilder('Picamator\SteganographyKit2\Kernel\StegoSystem\Api\ObserverInterface')
            ->getMock();
